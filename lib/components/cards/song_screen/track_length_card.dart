...
class TrackLengthCard extends ConsumerWidget {
  final String trackId;

  const TrackLengthCard({
    super.key,
      ...
      child: track.when(
        data: (track) {
          return TrackInfoCard(
            title: 'Length',
            content:
                '${(track.durationMs! ~/ 60000)} minutes, ${((track.durationMs! % 60000) ~/ 1000).toString().padLeft(2, '0')} seconds',
          );
        },
        loading: () {
